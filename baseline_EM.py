...
from src.models_EM import eu_model_ehu
...
for idx_m, m in enumerate(math_model_list):
    ...
    with open("results/baseline/aucroc_"+ math_model +"_EM"+"_hidden"+ ".pickle", 'wb') as metrics_pckl:#f_pckl:
        pickle.dump(l_auc_roc, metrics_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/baseline/metrics_"+ math_model +"_EM"+"_hidden"+ ".pickle", 'wb') as metrics_pckl:#f_pckl:
        pickle.dump(l_metrics, metrics_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/baseline/probabilities_"+ math_model +"_EM"+"_hidden"+ ".pickle", 'wb') as prob_pckl:#f_pckl:
        pickle.dump(pred_probs, prob_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/baseline/real_info_"+ math_model +"_EM"+"_hidden"+ ".pickle", 'wb') as impl_pckl:#f_pckl:
