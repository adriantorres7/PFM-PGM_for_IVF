...
for idx_m, m in enumerate(math_model_list):
    ...
    with open("results/ehu_experiment_distances_qr_euclidean_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as qr_euclidean_pckl:
    ...
    with open("results/ehu_experiment_distances_qr_rel_entropy_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as qr_rel_entropy_pckl:
    ...
    with open("results/ehu_experiment_distances_qw_euclidean_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as qw_euclidean_pckl:
    ...
    with open("results/ehu_experiment_distances_qw_rel_entropy_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as qw_rel_entropy_pckl:
    ...
    with open("results/ehu_experiment_distances_prb_euclidean_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as prb_euclidean_pckl:
    ...
    with open("results/ehu_experiment_distances_prb_rel_entropy_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as prb_rel_entropy_pckl:
    ...
    with open("results/ehu_experiment_distances_pwa_euclidean_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as pwa_euclidean_pckl:
    ...
    with open("results/ehu_experiment_distances_pwa_rel_entropy_"
          + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em) +"_hidden"+ ".pickle", 'wb') as pwa_rel_entropy_pckl:
    ...
    with open("results/ehu_experiment_metrics_"
              + math_model + "_k" + str(k_cv) + "_ems" + str(max_it_em)+"_hidden"+".pickle", 'wb') as metrics_pckl:#f_pckl:
        pickle.dump(l_metrics, metrics_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/probabilities_"+ math_model +"_hidden"+ ".pickle", 'wb') as prob_pckl:#f_pckl:
        pickle.dump(pred_probs, prob_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/real_info_"+ math_model +"_hidden"+".pickle", 'wb') as impl_pckl:#f_pckl:
        pickle.dump(real_info, impl_pckl, pickle.HIGHEST_PROTOCOL)
    with open("results/aucroc_"+ math_model+"_hidden"+ ".pickle", 'wb') as metrics_pckl:#f_pckl:
